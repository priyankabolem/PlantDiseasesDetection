...
class GradCAM:
    ...
    def _build_grad_model(self) -> Model:
        ...
        grad_model = Model(
            ...
            outputs=[conv_layer.output, self.model.outputs]
        )
    ...
    def _make_gradcam_heatmap(self, img_array: np.ndarray, pred_index: int) -> np.ndarray:
        """Generate Grad-CAM heatmap."""
    ...
    def _save_and_display_gradcam(self, 
                                 img_path: str, 
                                 heatmap: np.ndarray,
                                 output_path: str,
                                 alpha: float = 0.4):
    ...
    def generate_batch_heatmaps(self, 
                               image_paths: list, 
                               class_indices: list,
                               output_dir: str):
