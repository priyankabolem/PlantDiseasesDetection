...
class PlantDiseaseDataLoader:
    ...
    def create_data_generators(self, train_dir: str, valid_dir: Optional[str] = None) -> Tuple[tf.keras.preprocessing.image.DirectoryIterator, tf.keras.preprocessing.image.DirectoryIterator]:
        ...
        logger.info(f"Found {valid_generator.samples} validation images belonging to {valid_generator.num_classes} classes")
        
        return train_generator, valid_generator
    
    def get_class_names(self, generator: tf.keras.preprocessing.image.DirectoryIterator) -> Dict[int, str]:
        """Get class names from generator."""
        return {v: k for k, v in generator.class_indices.items()}
    
    def create_test_generator(self, test_dir: str) -> tf.keras.preprocessing.image.DirectoryIterator:
