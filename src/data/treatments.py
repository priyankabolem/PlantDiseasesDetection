...
TREATMENTS = {
    ...
    "Apple___Apple_scab": {
        ...
        "treatment": "Apply fungicides containing captan or myclobutanil. Remove and destroy infected leaves. Ensure good air circulation around trees.",
    },
    "Apple___Black_rot": {
        "symptoms": "Circular brown spots with concentric rings on leaves and fruit.",
        "treatment": "Prune out dead wood and infected branches. Apply fungicides during the growing season. Remove mummified fruits.",
    },
    "Apple___Cedar_apple_rust": {
        "symptoms": "Bright orange-red spots on leaves with yellow halos.",
        "treatment": "Apply fungicides in early spring. Remove nearby juniper/cedar trees if possible. Use resistant apple varieties.",
    },
    "Apple___healthy": {
    ...
    "Cherry_(including_sour)___Powdery_mildew": {
        ...
        "treatment": "Apply sulfur-based or horticultural oil fungicides. Prune for better air circulation. Remove infected plant debris.",
    },
    ...
    "Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot": {
        ...
        "treatment": "Use resistant hybrids. Apply foliar fungicides if severe. Practice crop rotation and tillage to reduce inoculum.",
    },
    "Corn_(maize)___Common_rust_": {
        "symptoms": "Small, circular to elongate brown pustules on leaves.",
        "treatment": "Plant resistant varieties. Apply fungicides if infection occurs early. Ensure proper plant spacing.",
    },
    ...
    "Grape___Black_rot": {
        ...
        "treatment": "Apply fungicides from bud break through veraison. Remove mummified berries and infected plant material.",
    },
    "Grape___Esca_(Black_Measles)": {
        "symptoms": "Dark streaks in wood, leaf discoloration, and shriveled berries.",
        "treatment": "No cure available. Remove severely infected vines. Avoid pruning during wet weather. Paint pruning wounds.",
    },
    ...
    "Orange___Haunglongbing_(Citrus_greening)": {
        ...
        "treatment": "No cure available. Remove infected trees. Control Asian citrus psyllid vector. Use certified disease-free plants.",
    },
    # Peach diseases
    ...
    "Potato___Early_blight": {
        ...
        "treatment": "Apply fungicides containing chlorothalonil or mancozeb. Practice crop rotation. Remove plant debris.",
    },
    "Potato___Late_blight": {
        "symptoms": "Water-soaked spots that turn brown and spread rapidly.",
        "treatment": "Apply fungicides preventively. Use resistant varieties. Destroy infected plants immediately.",
    },
    "Potato___healthy": {
        "symptoms": "No disease detected.",
    ...
    "Squash___Powdery_mildew": {
        ...
        "treatment": "Apply sulfur or potassium bicarbonate fungicides. Ensure good air circulation. Remove infected leaves.",
    },
    # Strawberry diseases
    "Strawberry___Leaf_scorch": {
        "symptoms": "Purple or brown spots on leaves with purple margins.",
        "treatment": "Remove infected leaves. Apply fungicides. Ensure proper plant spacing and avoid overhead watering.",
    },
...
def get_treatment_recommendation(disease_name: str) -> str:
    ...
    if disease_name in TREATMENTS:
        ...
        return "Treatment information not available for this disease. Please consult with a local agricultural expert."
