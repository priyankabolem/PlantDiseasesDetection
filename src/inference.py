...
class PlantDiseaseClassifier:
    ...
    def _load_class_names(self, model_path: str, class_names_path: Optional[str] = None) -> Dict[int, str]:
        """Load class names."""
    ...
    def predict(self, image_path: str, top_k: int = 3, generate_gradcam: bool = True) -> Dict:
